...
for random_state in args.states:
    ...
    for n_run in range(20):
        session.run(tf.global_variables_initializer())
        log_file_name = 'boston_SGD_{}_{}'.format(random_state, n_run)
        with open(log_file_name, 'w') as f:
            f.write('#{} random_state, {} run\niteration,posterior,train_llh,train_rmse,test_llh,test_rmse\n'.format(random_state, n_run))
        for t in range(T_start, T_start + T):
            ...
            if (t+1) % 1000 == 0:
                ...
                with open(log_file_name, 'a') as f:
                    f.write('{},{},{},{},{},{}\n'.format(t+1, t_posterior, t_train_llh, t_train_rmse, t_test_llh, t_test_rmse))
